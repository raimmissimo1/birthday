...
export const gifts: GiftConfig[] = [
  ...
  { id: "birthday-for-crush", slug: "birthday-for-crush", recipient: "Тебе", introLines: ["> сегодня твой день", "...", "> и этот сюрприз создан для тебя"], finalMessage: "С днём рождения! Пусть этот день будет таким же ярким и красивым, как ты.", musicUrl: "/music.mp3", theme: { cake: "cosmic", background: "stars", accentColor: "#9ee7ff" }, frames: [{ id: "dinner", image: "/orders/birthday-for-crush/dinner.jpg", position: [0.35, 0.735, 2.35], rotation: [0, -1.32, 0], scale: 0.48 }, { id: "blue-car", image: "/orders/birthday-for-crush/blue-car.jpg", position: [-1.8, 0.735, 2.2], rotation: [0, -1.52, 0], scale: 0.54 }, { id: "white-dress", image: "/orders/birthday-for-crush/white-dress.jpg", position: [-1.8, 0.735, -2.2], rotation: [0, -1.63, 0], scale: 0.54 }], cards: [] },
];
