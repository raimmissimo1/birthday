...
export const cakePresets: Record<CakePresetId, CakePreset> = {
  romantic: { id: "romantic", name: "Романтический", description: "Нежный крем, ягоды и цветы", tier: "standard", layers: ["#c84f7b", "#efadc5"], frosting: "#fff3e8", decoration: "flowers", decorationColor: "#a92f5b", candleCount: 4, candleColor: "#efadc5", flameColor: "#ffd36a", glow: 0.7, scale: 1 },
