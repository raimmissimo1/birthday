...
export const cakePresets: Record<CakePresetId, CakePreset> = {
  romantic: { id: "romantic", name: "Романтический", description: "Нежный крем, ягоды и цветы", tier: "standard", layers: ["#f6b4c8", "#e9789f"], frosting: "#fff5f7", decoration: "flowers", decorationColor: "#e74778", candleCount: 1, candleColor: "#f4a2ba", flameColor: "#ffd36a", glow: 0.7, scale: 1 },
